...
1. **Multiple Programming Languages** (Python, Java, JavaScript)
2. **Web Development** (Frontend and Backend)
3. **Database Management** (Theory and Practice)
4. **Software Engineering Principles** (MVC, SOLID principles)
...
| **Java** | Core Programming & OOP | `/java/` |
| **HTML/CSS/JS** | Frontend Development | `/Client Side Programming/` |
| **JSP/Servlets** | Web Application Development | `/Client and Server Side Programming/` |
| **Tomcat** | Application Server | Server Configuration |
